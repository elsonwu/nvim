...
require('lazy').setup({
    ...
    spec = {
        ...
        {'gelguy/wilder.nvim', config = function() require('setup-plugins.wilder') end },
        {'jparise/vim-graphql'},
        {'qpkorr/vim-bufkill'},
        ...
        {'jxnblk/vim-mdx-js'},
        {'goolord/alpha-nvim', dependencies = {'nvim-tree/nvim-web-devicons'}, config = function() require('setup-plugins.alpha') end }, -- vscode-like icons in completion
        {
        ...
        {'williamboman/mason.nvim', build = ':MasonUpdate', config = function() require('setup-plugins.mason') end },
        {'williamboman/mason-lspconfig.nvim', dependencies = {'williamboman/mason.nvim'}, config = function() require('setup-plugins.mason-lspconfig') end },
